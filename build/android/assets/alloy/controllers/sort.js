...
function Controller() {
    function __alloyId57() {
        $.__views.sortWindow.removeEventListener("open", __alloyId57);
        if ($.__views.sortWindow.activity) $.__views.sortWindow.activity.onCreateOptionsMenu = function(e) {
            ...
            $.__views.cancelSortBtn = e.menu.add(_.pick(__alloyId56, Alloy.Android.menuItemCreateArgs));
            $.__views.cancelSortBtn.applyProperties(_.omit(__alloyId56, Alloy.Android.menuItemCreateArgs));
    ...
    $.__views.sortWindow.addEventListener("open", __alloyId57);
    ...
    __alloyId58["elementTemplate"] = __alloyId60;
    $.__views.__alloyId68 = Ti.UI.createListSection({
        id: "__alloyId68"
    });
    var __alloyId70 = [];
    __alloyId70.push($.__views.__alloyId68);
    ...
    $.__views.sortWindow.add($.__views.__alloyId71);
    applySort ? $.addListener($.__views.__alloyId71, "click", applySort) : __defers["$.__views.__alloyId71!click!applySort"] = true;
    ...
    __defers["$.__views.__alloyId71!click!applySort"] && $.addListener($.__views.__alloyId71, "click", applySort);
    _.extend($, exports);
}
