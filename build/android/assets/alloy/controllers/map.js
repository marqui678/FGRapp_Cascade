...
function Controller() {
    function __alloyId61() {
        $.__views.mainWindow.removeEventListener("open", __alloyId61);
        if ($.__views.mainWindow.activity) $.__views.mainWindow.activity.onCreateOptionsMenu = function(e) {
            ...
            $.__views.__alloyId59 = e.menu.add(_.pick(__alloyId60, Alloy.Android.menuItemCreateArgs));
            $.__views.__alloyId59.applyProperties(_.omit(__alloyId60, Alloy.Android.menuItemCreateArgs));
            $.__alloyId59 = $.__views.__alloyId59;
            toSearch ? $.addListener($.__views.__alloyId59, "click", toSearch) : __defers["$.__views.__alloyId59!click!toSearch"] = true;
        }; else {
    ...
    $.__views.mainWindow.addEventListener("open", __alloyId61);
    ...
    __defers["$.__views.__alloyId59!click!toSearch"] && $.addListener($.__views.__alloyId59, "click", toSearch);
