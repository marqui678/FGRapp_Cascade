...
/**
 Base class for all FGR_Cascade views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the FGR_Cascade view hierarchy (such as wrapped iOS UIViews) was touched.
