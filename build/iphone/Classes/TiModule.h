...
/**
 The base class for all FGR_Cascade modules
 */
...
/**
 FGR_Cascade Platform calls this method on startup.
 */
-(void)startup;

/**
 FGR_Cascade Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 FGR_Cascade Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 FGR_Cascade Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 FGR_Cascade Platform calls this method on resume.
 @param sender The sender of the event.
 */
