...
//@interface FGR_CascadeObject : NSObject
//@end

@interface FGR_CascadeObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[FGR_CascadeObject class]])
		{
			for (NSString *key in [[(FGR_CascadeObject*)o modules] allKeys])
			{
