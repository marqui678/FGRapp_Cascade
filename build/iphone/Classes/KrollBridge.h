...
@interface FGR_CascadeObject : KrollCoverageObject {
#else
@interface FGR_CascadeObject : KrollObject {
#endif
@private
...
extern NSString * FGR_Cascade$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	FGR_CascadeObject *_fgr_cascade;
    KrollObject* console;
	BOOL shutdown;
