...
// in simulator we redefine to format for FGR_Cascade Developer console
...
{\
	NSString * exceptionName = [@"org.fgr_cascade." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.fgr_cascade";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIFGR_CascadeNativeItemNone = -1, 
	UIFGR_CascadeNativeItemSpinner = -2,
	UIFGR_CascadeNativeItemProgressBar = -3,
	
	UIFGR_CascadeNativeItemSlider = -4,
	UIFGR_CascadeNativeItemSwitch = -5,
	UIFGR_CascadeNativeItemMultiButton = -6,
	UIFGR_CascadeNativeItemSegmented = -7,
	
	UIFGR_CascadeNativeItemTextView = -8,
	UIFGR_CascadeNativeItemTextField = -9,
	UIFGR_CascadeNativeItemSearchBar = -10,
	
	UIFGR_CascadeNativeItemPicker = -11,
	UIFGR_CascadeNativeItemDatePicker = -12,
	
	UIFGR_CascadeNativeItemInfoLight = -13,
	UIFGR_CascadeNativeItemInfoDark = -14,
	
	UIFGR_CascadeNativeItemDisclosure = -15,
	
	UIFGR_CascadeNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all FGR_Cascade instances of
