...
function Controller() {
    ...
    $.__views.paceView.add($.__views.__alloyId5);
    ...
    $.__views.__alloyId5.add($.__views.easy);
    ...
    $.__views.__alloyId5.add($.__views.leisurely);
    ...
    $.__views.paceView.add($.__views.__alloyId6);
    ...
    $.__views.__alloyId6.add($.__views.steady);
    ...
    $.__views.__alloyId6.add($.__views.moderate);
    ...
    $.__views.paceView.add($.__views.__alloyId7);
    ...
    $.__views.__alloyId7.add($.__views.brisk);
    ...
    $.__views.__alloyId7.add($.__views.vigorous);
    ...
    $.__views.paceView.add($.__views.__alloyId8);
    ...
    $.__views.__alloyId8.add($.__views.strenuous);
    ...
    $.__views.__alloyId8.add($.__views.superStrenuous);
    ...
    $.__views.paceView.add($.__views.__alloyId9);
    ...
    $.__views.__alloyId9.add($.__views.selfPaced);
    ...
    $.__views.dayView.add($.__views.__alloyId11);
    sunday ? $.addListener($.__views.__alloyId11, "click", sunday) : __defers["$.__views.__alloyId11!click!sunday"] = true;
    $.__views.checkSunday = Ti.UI.createImageView({
        left: "16dp",
        id: "checkSunday",
        image: "images/unchecked.png"
    });
    $.__views.__alloyId11.add($.__views.checkSunday);
    ...
    $.__views.__alloyId11.add($.__views.sunday);
    ...
    $.__views.dayView.add($.__views.__alloyId12);
    monday ? $.addListener($.__views.__alloyId12, "click", monday) : __defers["$.__views.__alloyId12!click!monday"] = true;
    $.__views.checkMonday = Ti.UI.createImageView({
        left: "16dp",
        id: "checkMonday",
        image: "images/unchecked.png"
    });
    $.__views.__alloyId12.add($.__views.checkMonday);
    ...
    $.__views.__alloyId12.add($.__views.monday);
    ...
    $.__views.dayView.add($.__views.__alloyId13);
    tuesday ? $.addListener($.__views.__alloyId13, "click", tuesday) : __defers["$.__views.__alloyId13!click!tuesday"] = true;
    $.__views.checkTuesday = Ti.UI.createImageView({
        left: "16dp",
        id: "checkTuesday",
        image: "images/unchecked.png"
    });
    $.__views.__alloyId13.add($.__views.checkTuesday);
    ...
    $.__views.__alloyId13.add($.__views.tuesday);
    ...
    $.__views.dayView.add($.__views.__alloyId14);
    wednesday ? $.addListener($.__views.__alloyId14, "click", wednesday) : __defers["$.__views.__alloyId14!click!wednesday"] = true;
    $.__views.checkWednesday = Ti.UI.createImageView({
        left: "16dp",
        id: "checkWednesday",
        image: "images/unchecked.png"
    });
    $.__views.__alloyId14.add($.__views.checkWednesday);
    ...
    $.__views.__alloyId14.add($.__views.wednesday);
    ...
    $.__views.dayView.add($.__views.__alloyId15);
    thursday ? $.addListener($.__views.__alloyId15, "click", thursday) : __defers["$.__views.__alloyId15!click!thursday"] = true;
    $.__views.checkThursday = Ti.UI.createImageView({
        left: "16dp",
        id: "checkThursday",
        image: "images/unchecked.png"
    });
    $.__views.__alloyId15.add($.__views.checkThursday);
    ...
    $.__views.__alloyId15.add($.__views.thursday);
    ...
    $.__views.dayView.add($.__views.__alloyId16);
    friday ? $.addListener($.__views.__alloyId16, "click", friday) : __defers["$.__views.__alloyId16!click!friday"] = true;
    $.__views.checkFriday = Ti.UI.createImageView({
        left: "16dp",
        id: "checkFriday",
        image: "images/unchecked.png"
    });
    $.__views.__alloyId16.add($.__views.checkFriday);
    ...
    $.__views.__alloyId16.add($.__views.friday);
    ...
    $.__views.dayView.add($.__views.__alloyId17);
    saturday ? $.addListener($.__views.__alloyId17, "click", saturday) : __defers["$.__views.__alloyId17!click!saturday"] = true;
    $.__views.checkSaturday = Ti.UI.createImageView({
        left: "16dp",
        id: "checkSaturday",
        image: "images/unchecked.png"
    });
    $.__views.__alloyId17.add($.__views.checkSaturday);
    ...
    $.__views.__alloyId17.add($.__views.saturday);
    ...
    $.__views.timeView.add($.__views.__alloyId19);
    ...
    $.__views.__alloyId19.add($.__views.startTimeLabel);
    ...
    $.__views.timeView.add($.__views.__alloyId21);
    ...
    $.__views.timeView.add($.__views.__alloyId22);
    ...
    $.__views.__alloyId22.add($.__views.endTimeLabel);
    ...
    $.__views.distanceView.add($.__views.__alloyId25);
    ...
    $.__views.__alloyId25.add($.__views.ten);
    ...
    $.__views.__alloyId25.add($.__views.twenty);
    ...
    $.__views.distanceView.add($.__views.__alloyId26);
    ...
    $.__views.__alloyId26.add($.__views.thirty);
    ...
    $.__views.__alloyId26.add($.__views.fourty);
    ...
    $.__views.distanceView.add($.__views.__alloyId27);
    ...
    $.__views.__alloyId27.add($.__views.fifty);
    ...
    $.__views.__alloyId27.add($.__views.sixty);
    ...
    $.__views.distanceView.add($.__views.__alloyId28);
    ...
    $.__views.__alloyId28.add($.__views.seventy);
    ...
    $.__views.__alloyId28.add($.__views.eighty);
    ...
    $.__views.distanceView.add($.__views.__alloyId29);
    ...
    $.__views.__alloyId29.add($.__views.ninety);
    ...
    __defers["$.__views.__alloyId11!click!sunday"] && $.addListener($.__views.__alloyId11, "click", sunday);
    __defers["$.__views.__alloyId12!click!monday"] && $.addListener($.__views.__alloyId12, "click", monday);
    __defers["$.__views.__alloyId13!click!tuesday"] && $.addListener($.__views.__alloyId13, "click", tuesday);
    __defers["$.__views.__alloyId14!click!wednesday"] && $.addListener($.__views.__alloyId14, "click", wednesday);
    __defers["$.__views.__alloyId15!click!thursday"] && $.addListener($.__views.__alloyId15, "click", thursday);
    __defers["$.__views.__alloyId16!click!friday"] && $.addListener($.__views.__alloyId16, "click", friday);
    __defers["$.__views.__alloyId17!click!saturday"] && $.addListener($.__views.__alloyId17, "click", saturday);
